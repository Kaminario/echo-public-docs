...
$InstallScriptName = "setup-one-host.ps1"
...
function Install-SingleHost {
    ...
    $scriptBlock = {
        param($FlexIP, $FlexToken, $DBConnectionString, $SilkAgentURL, $SilkVSSURL, $SDPId, $SDPUsername, $SDPPassword, $DebugMode, $DryRunMode, $Script)
...
if (-Not $ConfigPath) {
    ...
    InfoMessage "Usage: .\setup.ps1 -ConfigPath <path_to_config_file>"
    Exit 1
}
