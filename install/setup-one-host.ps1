...
.EXAMPLE
    .\setup-one-host.ps1 -FlexIP "10.0.0.1" -FlexToken "abc123" -DBConnectionString "server=localhost;..." -SilkAgentURL "https://..." -SilkVSSURL "https://..." -SDPId "d9b601" -SDPUsername "admin" -SDPPassword "password"
    
    Installs Silk Echo components with the specified parameters.

.EXAMPLE
    .\setup-one-host.ps1 -FlexIP "10.0.0.1" -FlexToken "abc123" -DBConnectionString "server=localhost;..." -SilkAgentURL "https://..." -SilkVSSURL "https://..." -SDPId "d9b601" -SDPUsername "admin" -SDPPassword "password" -DryRun
    
    Performs validation and connectivity tests without installing the components.

.NOTES
    File Name      : setup-one-host.ps1
    Author         : Silk.us, Inc.
...
$ArgumentList = @(
        ...
        "/log_level_provider=trace",
        "/log_level_json=trace",
        "/log_level_configurator=trace",
        '/check_vg_full=false',
