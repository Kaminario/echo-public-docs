...
Tests:
- GET /api/ocie/v1/tasks (direct endpoint)
...
def run(
    ...
    Args:
        ...
        snapshot_prefix: Prefix for snapshot name (default: "test-list-")
    ...
    print(f"Testing task listing endpoints")
    ...
    try:
        # Create a snapshot to generate a task
        ...
        task = _make_request("POST", "/api/ocie/v1/db_snapshots", payload=create_payload)
        ...
        print("\n2. Testing GET /api/ocie/v1/tasks")
        tasks_list = _make_request("GET", "/api/ocie/v1/tasks")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test task listing endpoints")
    ...
    parser.add_argument("--snapshot-prefix", default="test-list-", help="Prefix for snapshot name (default: 'test-list-')")
